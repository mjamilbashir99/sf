...
$active_record = TRUE;
/* for live **************/
$db['default']['hostname'] = 'mysql4.ilait.se';
$db['default']['username'] = 'udmyss168435';
$db['default']['password'] = 'sEj=9JKX';
$db['default']['database'] = 'dss107211';
