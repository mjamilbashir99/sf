...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'SaleFinder.se';
$config['webmaster_email'] = 'info@salefinder.se';
...
|--------------------------------------------------------------------------
*/
$config['captcha_path'] = 'captcha/images/';
...
$config['recaptcha_public_key'] = '6LfS_s4SAAAAAGa_pH8K8eZCaI5mIsBYGyxpvPOM';
$config['recaptcha_private_key'] = '6LfS_s4SAAAAAL9_KRkBsHYP8JlUsAehPmMG4ATR';
